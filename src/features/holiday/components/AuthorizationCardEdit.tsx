              ...
              {userAuthenticated.role === 'manager' &&
                holiday.authorizationManager !== 'approved' && (
                  <AuthorizationButtons>
                    <ButtonState
                      type="button"
                      onClick={handleButtonAprove}
                      $color={
                        authorizationEditManager === 'approved' ? '#087f5b' : '#a0a0a0'
                      }
                    >
                      <HiOutlineCheck />
                      Aceptar
                    ...
                    <ButtonState
                      ...
                      $color={
                        authorizationEditManager === 'rejected' ? '#a61e4d' : '#a0a0a0'
                      }
                    >
                      <HiOutlineXMark />
                      Rechazar
                    ...
                    <GeneralButton
                      type="submit"
                      onClick={() => setValue('authorizationManager', requestState)}
                      $variation="secondary"
                    >
                      GUARDAR CAMBIOS
                    </GeneralButton>
                ...
                holiday.authorizationAdmin !== 'rejected' && (
                  <AuthorizationButtons>
                    <ButtonState
                      ...
                      onClick={handleButtonAprove}
                      $color={
                        authorizationEditAdmin === 'approved' ? '#087f5b' : '#a0a0a0'
                      }
                    >
                      <HiOutlineCheck />
                      Aceptar
                    ...
                    <ButtonState
                      ...
                      onClick={handleButtonReject}
                      $color={
                        authorizationEditAdmin === 'rejected' ? '#a61e4d' : '#a0a0a0'
                      }
                    >
                      <HiOutlineXMark />
                      Rechazar
              ...
              {userAuthenticated.role === 'admin' &&
                ...
                isEddit && (
                  <AuthorizationButtons>
                    ...
                    <GeneralButton
                      type={authorizationEditAdmin === 'rejected' ? 'button' : 'submit'}
                      onClick={() => setValue('authorizationAdmin', requestState)}
                      $variation="secondary"
                    >
                      GUARDAR CAMBIOS
